[1_Weather_Observation_Station_9](https://www.hackerrank.com/challenges/weather-observation-station-9/problem): 
* **Question:**
...
[22_MAX_lat_n](https://www.hackerrank.com/challenges/weather-observation-station-14/problem?isFullScreen=true&h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen): 
* **Question:**
...
[24_Weather_Observation_Station_17](https://www.hackerrank.com/challenges/weather-observation-station-16/problem?isFullScreen=true): 
* **Question: (not phrased well)**
> * Query the Western Longitude (LONG_W)where the smallest Northern Latitude (LAT_N) in STATION is greater than . Round your answer to  decimal places.
* [Solution](https://github.com/Jtrahan88/SQL/blob/main/HackerRank/SQL-Basics/24_Weather_Observation_Station_17)
---

[25_Weather_Observation_Station_18](https://www.hackerrank.com/challenges/weather-observation-station-18/problem?isFullScreen=true&h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen): 
* **Question:**
...
[27_Weather_Observation_Station_19](https://www.hackerrank.com/challenges/weather-observation-station-19/problem?isFullScreen=true&h_r=next-challenge&h_v=zen): 
* **Question:**
> * Consider P1(a,c) and P2(b,d) to be two points on a 2D plane where (a,b) are the respective minimum and maximum values of Northern Latitude (LAT_N) and (c,d) are the respective minimum and maximum values of Western Longitude (LONG_W) in STATION.

Query the Euclidean Distance between points P1 and P2 and format your answer to display 4 decimal digits.
* [Solution](https://github.com/Jtrahan88/SQL/blob/main/HackerRank/SQL-Basics/27_Weather_Observation_Station_19)
---
